...
describe('ClaimantBenefitsController', () => {
  ...
  describe('post()', () => {
    it('should redirect to FIRST_RESPONDENT_NAME on Yes with benefits text (AC3)', async () => {
    ...
    it('should redirect to FIRST_RESPONDENT_NAME on No (AC3)', async () => {
    ...
    it('should redirect to FIRST_RESPONDENT_NAME when no answer given (AC3)', async () => {
