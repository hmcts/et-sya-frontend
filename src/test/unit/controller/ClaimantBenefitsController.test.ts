...
describe('ClaimantBenefitsController', () => {
  ...
  describe('post()', () => {
    it('should redirect to CLAIMANT_RESPONDENT_NAME on Yes with benefits text', async () => {
    ...
    it('should redirect to CLAIMANT_RESPONDENT_NAME on No', async () => {
    ...
    it('should redirect to CLAIMANT_RESPONDENT_NAME when no answer given', async () => {
