...
describe('Case Document Controller', () => {
  ...
  it('should retrieve the binary document when no mime-type but original document name in document detail',
    async () => {
      getUserCasesMock.mockResolvedValue(userCases);
      getUserAppMock.mockReturnValue(mockApplications);
      getCaseApiMock.mockReturnValue(api);
  ...
  it('should retrieve the binary document when no mime-type in document detail but content-type in document',
    async () => {
    getUserCasesMock.mockResolvedValue(userCases);
    getUserAppMock.mockReturnValue(mockApplications);
    getCaseApiMock.mockReturnValue(api);
  ...
  it('should retrieve the binary document when no mime-type in document detail but original filename in document',
    async () => {
      getUserCasesMock.mockResolvedValue(userCases);
      getUserAppMock.mockReturnValue(mockApplications);
      getCaseApiMock.mockReturnValue(api);
  ...
  it('should retrieve the binary document when no mime-type in document detail but filename in document',
    async () => {
      getUserCasesMock.mockResolvedValue(userCases);
      getUserAppMock.mockReturnValue(mockApplications);
      getCaseApiMock.mockReturnValue(api);
  ...
  it('should retrieve the binary document when no mime-type in document detail and nothing in document',
    async () => {
      getUserCasesMock.mockResolvedValue(userCases);
      getUserAppMock.mockReturnValue(mockApplications);
      getCaseApiMock.mockReturnValue(api);
