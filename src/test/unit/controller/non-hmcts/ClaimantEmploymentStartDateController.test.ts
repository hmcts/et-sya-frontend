...
import ClaimantEmploymentStartDateController from '../../../../main/controllers/non-hmcts/ClaimantEmploymentStartDateController';
...
describe('ClaimantEmploymentStartDateController', () => {
  const t = {
    'non-hmcts/claimant-employment-start-date': {},
    common: {},
  };
