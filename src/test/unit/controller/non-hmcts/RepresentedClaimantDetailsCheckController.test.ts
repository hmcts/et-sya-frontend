...
import RepresentedClaimantDetailsCheckController from '../../../../main/controllers/non-hmcts/RepresentedClaimantDetailsCheckController';
...
describe('Represented Claimant Details Check Controller', () => {
  const t = {
    'non-hmcts/represented-claimant-details-check': {},
    common: {},
  };
