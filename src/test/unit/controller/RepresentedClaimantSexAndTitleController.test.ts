...
import RepresentedClaimantSexAndTitleController from '../../../main/controllers/represented-claimant/RepresentedClaimantSexAndTitleController';
...
describe('RepresentedClaimantSexAndTitleController', () => {
  const t = {
    'represented-claimant-sex-and-title': {},
    common: {},
  };
