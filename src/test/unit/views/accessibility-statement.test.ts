...
describe('Accessibility statement page', () => {
  ...
  it('should display 31 paragraphs', () => {
    ...
    expect(p.length).equal(36, `${p.length} paragraphs found - expected 36`);
    expect(p[5].innerHTML).contains(expectedParagraph_s1_1, paragraphDoesNotExist);
    expect(p[6].innerHTML).contains(expectedParagraph_s1_2, paragraphDoesNotExist);
    expect(p[7].innerHTML).contains(expectedParagraph_s1_3, paragraphDoesNotExist);
    expect(p[8].innerHTML).contains(expectedParagraph_s1_4, paragraphDoesNotExist);
    expect(p[9].innerHTML).contains(expectedParagraph_s2_1, paragraphDoesNotExist);
    expect(p[10].innerHTML).contains(expectedParagraph_s3_1, paragraphDoesNotExist);
    expect(p[11].innerHTML).contains(expectedParagraph_s3_2, paragraphDoesNotExist);
    expect(p[12].innerHTML).contains(expectedParagraph_s3_3, paragraphDoesNotExist);
    expect(p[13].innerHTML).contains(expectedParagraph_s4_1, paragraphDoesNotExist);
    expect(p[14].innerHTML).contains(expectedParagraph_s4_2, paragraphDoesNotExist);
    expect(p[15].innerHTML).contains(expectedParagraph_s5_1, paragraphDoesNotExist);
    expect(p[16].innerHTML).contains(expectedParagraph_s6_1, paragraphDoesNotExist);
    expect(p[17].innerHTML).contains(expectedParagraph_s6_2, paragraphDoesNotExist);
    expect(p[18].innerHTML).contains(expectedParagraph_s6_3, paragraphDoesNotExist);
    expect(p[19].innerHTML).contains(expectedParagraph_s7_1, paragraphDoesNotExist);
    expect(p[20].innerHTML).contains(expectedParagraph_s8_1, paragraphDoesNotExist);
    expect(p[21].innerHTML).contains(expectedParagraph_s9_1, paragraphDoesNotExist);
    expect(p[22].innerHTML).contains(expectedParagraph_s9_2, paragraphDoesNotExist);
    expect(p[23].innerHTML).contains(expectedParagraph_s9_3, paragraphDoesNotExist);
    expect(p[24].innerHTML).contains(expectedParagraph_s9_4, paragraphDoesNotExist);
    expect(p[25].innerHTML).contains(expectedParagraph_s9_5, paragraphDoesNotExist);
    expect(p[26].innerHTML).contains(expectedParagraph_s10_1, paragraphDoesNotExist);
    expect(p[27].innerHTML).contains(expectedParagraph_s11_1, paragraphDoesNotExist);
    expect(p[28].innerHTML).contains(expectedParagraph_s11_2, paragraphDoesNotExist);
    expect(p[29].innerHTML).contains(expectedParagraph_s11_3, paragraphDoesNotExist);
    expect(p[30].innerHTML).contains(expectedParagraph_s11_4, paragraphDoesNotExist);
    expect(p[31].innerHTML).contains(expectedParagraph_s11_5, paragraphDoesNotExist);
    expect(p[32].innerHTML).contains(expectedParagraph_s11_6, paragraphDoesNotExist);
    expect(p[33].innerHTML).contains(expectedParagraph_s11_7, paragraphDoesNotExist);
    expect(p[34].innerHTML).contains(expectedParagraph_s11_8, paragraphDoesNotExist);
    expect(p[35].innerHTML).contains(expectedParagraph_s11_9, paragraphDoesNotExist);
  });
