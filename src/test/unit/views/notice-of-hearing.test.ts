...
const PAGE_URL = '/case-document/notice-of-hearing';
...
describe('Citizen Hub Notice of Hearing', () => {
  beforeAll(async () => {
    await request(
      mockApp({
        userCase: {
          noticeOfHearingLetterDetail: [{ id: 'abc123', description: 'text' }],
  ...
  it('should display title', () => {
    ...
    expect(title[0].innerHTML).toContain('Notice of Hearing');
  });
