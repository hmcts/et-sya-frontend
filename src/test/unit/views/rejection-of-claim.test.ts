...
describe('Citizen Hub rejection of Claim', () => {
  beforeAll(async () => {
    await request(
      mockApp({
        userCase: {
          rejectionOfClaimDocumentDetail: [{ id: 'abc123', description: 'text', originalDocumentName: 'sample.pdf' }],
  ...
  it('should display title', () => {
    ...
    expect(title[0].innerHTML).toContain('Rejection of Claim');
  });
