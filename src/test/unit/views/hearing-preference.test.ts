...
const hearingPreferenceJsonRaw = fs.readFileSync(
  path.resolve(__dirname, '../../../main/resources/locales/en/translation/hearing-preference.json'),
  'utf-8'
);
const hearingPreferenceJson = JSON.parse(hearingPreferenceJsonRaw);
const PAGE_URL = PageUrls.HEARING_PREFERENCE;
const titleClass = 'govuk-heading-xl';
const pClass = 'govuk-body';
const expectedTitle = hearingPreferenceJson.h1;
const expectedP1 = hearingPreferenceJson.p1;
const buttonClass = 'govuk-button';
const checkboxClass = 'govuk-checkboxes__input';
const checkboxLabel = 'govuk-checkboxes__label';
const expectedLabel1 = hearingPreferenceJson.checkboxVideo;
const expectedLabel2 = hearingPreferenceJson.checkboxPhone;
const expectedLabel3 = hearingPreferenceJson.checkboxNeither;
