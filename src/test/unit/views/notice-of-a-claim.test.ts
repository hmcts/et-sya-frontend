...
const PAGE_URL = '/case-document/notice-of-a-claim';
...
describe('Citizen Hub Notice of a claim', () => {
  beforeAll(async () => {
    await request(
      mockApp({
        userCase: {
          noticeOfClaimLetterDetail: [{ id: 'abc123', description: 'text' }],
  ...
  it('should display title', () => {
    ...
    expect(title[0].innerHTML).toContain('Notice of a claim');
  });
