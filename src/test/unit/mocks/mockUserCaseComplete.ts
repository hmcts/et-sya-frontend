...
export default {
  ...
  representedClaimantAddress1: 'address 1',
  representedClaimantAddress2: 'address 2',
  representedClaimantAddressTown: 'Test',
  representedClaimantAddressCountry: 'United',
  representedClaimantAddressPostcode: 'TEST',
