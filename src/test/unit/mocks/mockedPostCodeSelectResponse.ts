export const postcodeSelectResponse = [
  {
    county: 'EXETER',
  ...
  {
    county: 'EXETER',
    fullAddress: 'The Wall House, Hope Court, Prince Of Wales Road, Exeter, EX4 4PN',
    postcode: 'EX4 4PN',
    street1: 'The Wall House, Hope Court, Prince Of Wales Road',
    street2: '',
    town: 'EXETER',
    country: 'ENGLAND',
  },
