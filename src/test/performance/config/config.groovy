	...
	this.dynatraceEntitySelectorAAT = 'type(service),tag(\\"[Kubernetes]namespace:et\\"),tag(\\"Environment:AAT\\"),entityName.equals(\\"AAT et - et-sya \\")'
	...
	//Perftest Config
	this.dynatraceSyntheticTestPerfTest = "SYNTHETIC_TEST-008CAF328F244320"
	...
	this.dynatraceEntitySelectorPerfTest = 'type(service),tag(\\"[Kubernetes]namespace:et\\"),tag(\\"Environment:PERF\\"),entityName.equals(\\"PERF et - et-sya \\")'
