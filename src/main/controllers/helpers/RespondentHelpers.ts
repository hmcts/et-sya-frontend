...
export const ValidRespondentUrls = {
  ...
  address1Manual: respondent + 1 + PageUrls.RESPONDENT_ADDRESS_MANUAL,
  address2Manual: respondent + 2 + PageUrls.RESPONDENT_ADDRESS_MANUAL,
  address3Manual: respondent + 3 + PageUrls.RESPONDENT_ADDRESS_MANUAL,
  address4Manual: respondent + 4 + PageUrls.RESPONDENT_ADDRESS_MANUAL,
  address5Manual: respondent + 5 + PageUrls.RESPONDENT_ADDRESS_MANUAL,
