...
export default class CitizenHubController {
  public async get(req: AppRequest, res: Response): Promise<void> {
    ...
    res.render(TranslationKeys.CITIZEN_HUB, {
      ...
      showNoticeOfClaimAlert: shouldShowNoticeOfClaimAlert(userCase, hubLinksStatuses),
      showNoticeOfHearingAlert: shouldShowNoticeOfHearingAlert(userCase, hubLinksStatuses),
