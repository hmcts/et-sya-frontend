...
const logger = getLogger('ClaimantPayController');

export default class ClaimantPayController {
  ...
  public post = async (req: AppRequest, res: Response): Promise<void> => {
    await handlePostLogic(req, res, this.form, logger, PageUrls.CLAIMANT_PENSION);
  };
  ...
  public get = (req: AppRequest, res: Response): void => {
    ...
    const content = getPageContent(req, this.formContent, [TranslationKeys.COMMON, TranslationKeys.CLAIMANT_PAY]);
    assignFormData(req.session.userCase, this.form.getFormFields());
    res.render(TranslationKeys.CLAIMANT_PAY, {
      ...content,
