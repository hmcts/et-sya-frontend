...
export const TranslationKeys = {
  ...
  HEARING_PREFERENCE: 'hearing-preference',
...
export const PageUrls = {
  ...
  ADDRESS_DETAILS: '/address-details',
  CONTACT_ACAS: '/contact-acas',
  HEARING_PREFERENCE: '/would-you-want-to-take-part-in-video-hearings',
  TELEPHONE_NUMBER: '/telephone-number',
  GENDER_DETAILS: '/gender-details',
  CONTACT_PREFERENCE: '/how-would-you-like-to-be-contacted-about-your-claim',
  JOB_TITLE: '/job-title',
  PAST_EMPLOYER: '/past-employer',
  PENSION: '/pension',
  START_DATE: '/start-date',
