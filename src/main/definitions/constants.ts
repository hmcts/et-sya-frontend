...
export const PageUrls = {
  ...
  HOME_WELSH: '/?lng=cy',
  CHECKLIST: '/checklist',
  CHECKLIST_ENGLISH: '/checklist?lng=en',
  CHECKLIST_WELSH: '/checklist?lng=cy',
  CLAIM_SAVED: '/your-claim-has-been-saved',
  CLAIM_STEPS: '/steps-to-making-your-claim',
  CLAIM_SUBMITTED: '/your-claim-has-been-submitted',
  RETURN_TO_EXISTING: '/return-to-existing',
  LIP_OR_REPRESENTATIVE: '/lip-or-representative',
  LIP_OR_REPRESENTATIVE_ENGLISH: '/lip-or-representative?lng=en',
  LIP_OR_REPRESENTATIVE_WELSH: '/lip-or-representative?lng=cy',
  SINGLE_OR_MULTIPLE_CLAIM: '/single-or-multiple-claim',
  SINGLE_OR_MULTIPLE_CLAIM_ENGLISH: '/single-or-multiple-claim?lng=en',
  SINGLE_OR_MULTIPLE_CLAIM_WELSH: '/single-or-multiple-claim?lng=cy',
  ACAS_MULTIPLE_CLAIM: '/do-you-have-an-acas-no-many-resps',
  ACAS_MULTIPLE_CLAIM_ENGLISH: '/do-you-have-an-acas-no-many-resps?lng=en',
  ACAS_MULTIPLE_CLAIM_WELSH: '/do-you-have-an-acas-no-many-resps?lng=cy',
  VALID_ACAS_REASON: '/do-you-have-a-valid-no-acas-reason',
  VALID_ACAS_REASON_ENGLISH: '/do-you-have-a-valid-no-acas-reason?lng=en',
  VALID_ACAS_REASON_WELSH: '/do-you-have-a-valid-no-acas-reason?lng=cy',
  ...
  ADDRESS_DETAILS: '/address-details',
  CONTACT_ACAS: '/contact-acas',
  CONTACT_ACAS_ENGLISH: '/contact-acas?lng=en',
  CONTACT_ACAS_WELSH: '/contact-acas?lng=cy',
  ...
  WORK_POSTCODE: '/work-postcode',
  WORK_POSTCODE_ENGLISH: '/work-postcode?lng=en',
  WORK_POSTCODE_WELSH: '/work-postcode?lng=cy',
  ...
  COOKIE_PREFERENCES_ENGLISH: '/cookies?lng=en',
  COOKIE_PREFERENCES_WELSH: '/cookies?lng=cy',
