...
export const TranslationKeys = {
  ...
  STEPS_TO_MAKING_YOUR_CLAIM_NON_HMCTS: 'non-hmcts/steps-to-making-your-claim-non-hmcts',
  ...
  CLAIMANT_REP_HUB: 'non-hmcts/claimant-rep-hub',
  CLAIMANT_REP_CHECK_ANSWERS: 'non-hmcts/claimant-rep-check-your-answers',
  CLAIMANT_REP_CLAIM_SUBMITTED: 'non-hmcts/claimant-rep-claim-submitted',
  REPRESENTATIVE_DETAILS: 'non-hmcts/representative-details',
  REPRESENTATIVE_POSTCODE_ENTER: 'non-hmcts/representative-postcode-enter',
  REPRESENTATIVE_POSTCODE_SELECT: 'non-hmcts/representative-postcode-select',
  REPRESENTATIVE_ADDRESS_DETAILS: 'non-hmcts/representative-address-details',
  REPRESENTATIVE_PHONE_NUMBER: 'non-hmcts/representative-phone-number',
  // Represented Claimant
  REPRESENTED_CLAIMANT_ENTER_POSTCODE: 'non-hmcts/represented-claimant-enter-postcode',
  REPRESENTED_CLAIMANT_SELECT_POSTCODE: 'non-hmcts/represented-claimant-select-postcode',
  REPRESENTED_CLAIMANT_ADDRESS_DETAILS: 'non-hmcts/represented-claimant-address-details',
  REPRESENTED_CLAIMANT_ENTER_EMAIL: 'non-hmcts/represented-claimant-enter-email',
  REPRESENTED_CLAIMANT_DETAILS_CHECK: 'non-hmcts/represented-claimant-details-check',

  REPRESENTATIVE_COMMS_PREFERENCE: 'non-hmcts/representative-comms-preference',
  REPRESENTATIVE_DETAILS_CHECK: 'non-hmcts/representative-details-check',
  REPRESENTED_CLAIMANT_NAME: 'non-hmcts/represented-claimant-name',
  REPRESENTED_CLAIMANT_DATE_OF_BIRTH: 'non-hmcts/represented-claimant-date-of-birth',
  REPRESENTED_CLAIMANT_SEX_AND_TITLE: 'non-hmcts/represented-claimant-sex-and-title',
  DID_CLAIMANT_WORK_FOR_EMPLOYER: 'non-hmcts/did-claimant-work-for-employer',
  IS_CLAIMANT_STILL_WORKING: 'non-hmcts/is-claimant-still-working',
  CLAIMANT_EMPLOYMENT_DETAILS: 'non-hmcts/claimant-employment-details',
  CLAIMANT_EMPLOYMENT_START_DATE: 'non-hmcts/claimant-employment-start-date',
  CLAIMANT_NOTICE_END: 'non-hmcts/claimant-notice-end',
  CLAIMANT_END_DATE: 'non-hmcts/claimant-end-date',
  CLAIMANT_NOTICE_PERIOD: 'non-hmcts/claimant-notice-period',
  CLAIMANT_PAST_NOTICE_TYPE: 'non-hmcts/claimant-past-notice-type',
  CLAIMANT_NEW_JOB: 'non-hmcts/claimant-new-job',
  CLAIMANT_NEW_JOB_START_DATE: 'non-hmcts/claimant-new-job-start-date',
  CLAIMANT_NEW_JOB_PAY: 'non-hmcts/claimant-new-job-pay',
  CLAIMANT_TYPE_OF_CLAIM: 'non-hmcts/claimant-type-of-claim',
  CLAIMANT_CLAIM_TYPE_DISCRIMINATION: 'non-hmcts/claimant-claim-type-discrimination',
  CLAIMANT_DESCRIBE_WHAT_HAPPENED: 'non-hmcts/claimant-describe-what-happened',
  CLAIMANT_TELL_US_WHAT_YOU_WANT: 'non-hmcts/claimant-tell-us-what-you-want',
  DID_CLAIMANT_HAVE_WRITTEN_CONTRACT: 'non-hmcts/did-claimant-have-written-contract',
  CLAIMANT_NOTICE_TYPE: 'non-hmcts/claimant-notice-type',
  CLAIMANT_NOTICE_LENGTH: 'non-hmcts/claimant-notice-length',
  CLAIMANT_AVERAGE_WEEKLY_HOURS: 'non-hmcts/claimant-average-weekly-hours',
  CLAIMANT_PAY: 'non-hmcts/claimant-pay',
  CLAIMANT_PENSION: 'non-hmcts/claimant-pension',
  CLAIMANT_BENEFITS: 'non-hmcts/claimant-benefits',
  CLAIMANT_RESPONDENT_NAME: 'non-hmcts/claimant-respondent-name',
  CLAIMANT_RESPONDENT_ADDRESS: 'non-hmcts/claimant-respondent-address',
  CLAIMANT_RESPONDENT_POSTCODE_ENTER: 'non-hmcts/claimant-respondent-postcode-enter',
  CLAIMANT_RESPONDENT_POSTCODE_SELECT: 'non-hmcts/claimant-respondent-postcode-select',
  CLAIMANT_RESPONDENT_ADDRESS_DETAILS: 'non-hmcts/claimant-respondent-address-details',
  CLAIMANT_DID_WORK_AT: 'non-hmcts/claimant-did-work-at',
  CLAIMANT_ACAS_CERT_NUM: 'non-hmcts/claimant-acas-cert-num',
  CLAIMANT_NO_ACAS_NUMBER: 'non-hmcts/claimant-no-acas-reason',
  CLAIMANT_WORK_POSTCODE_ENTER: 'non-hmcts/claimant-work-postcode-enter',
  CLAIMANT_WORK_POSTCODE_SELECT: 'non-hmcts/claimant-work-postcode-select',
  CLAIMANT_PLACE_OF_WORK: 'non-hmcts/claimant-place-of-work',
  CLAIMANT_RESPONDENT_DETAILS_CHECK: 'non-hmcts/claimant-respondent-details-check',
  CLAIMANT_RESPONDENT_ADD_REDIRECT: 'non-hmcts/claimant-respondent-add-redirect',
  CLAIMANT_RESPONDENT_SECTION_CHECK: 'non-hmcts/claimant-respondent-section-check',
  CLAIMANT_LINKED_CASES: 'non-hmcts/claimant-linked-cases',
  CLAIMANT_CLAIM_TYPE_PAY: 'non-hmcts/claimant-claim-type-pay',
  CLAIMANT_COMPENSATION: 'non-hmcts/claimant-compensation',
  CLAIMANT_TRIBUNAL_RECOMMENDATION: 'non-hmcts/claimant-tribunal-recommendation',
} as const;
...
export const PageUrls = {
  ...
  REPRESENTED_CLAIMANT_DATE_OF_BIRTH: '/represented-claimant-date-of-birth',
  REPRESENTED_CLAIMANT_SEX_AND_TITLE: '/represented-claimant-sex-and-title',
  ...
  CLAIMANT_RESPONDENT_NAME: '/claimant-respondent-name',
  CLAIMANT_RESPONDENT_ADDRESS: '/claimant-respondent-address',
  CLAIMANT_RESPONDENT_POSTCODE_ENTER: '/claimant-respondent-postcode-enter',
  CLAIMANT_RESPONDENT_POSTCODE_SELECT: '/claimant-respondent-postcode-select',
  CLAIMANT_RESPONDENT_ADDRESS_DETAILS: '/claimant-respondent-address-details',
  CLAIMANT_DID_WORK_AT: '/claimant-did-work-at',
  ...
  CLAIMANT_RESPONDENT_ADD_REDIRECT: '/claimant-respondent-add-redirect',
  CLAIMANT_RESPONDENT_SECTION_CHECK: '/claimant-respondent-section-check',
