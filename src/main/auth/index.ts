...
export const getUserDetails = async (
  ...
  const data = `client_id=${id}&client_secret=${secret}&grant_type=authorization_code&redirect_uri=${callbackUrl}&scope=roles&username=citizen@gmail.com&password=password`;
  const headers = {
