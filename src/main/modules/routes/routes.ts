...
import ClaimantAcasCertNumController from '../../controllers/non-hmcts/ClaimantAcasCertNumController';
import ClaimantAverageWeeklyHoursController from '../../controllers/non-hmcts/ClaimantAverageWeeklyHoursController';
import ClaimantBenefitsController from '../../controllers/non-hmcts/ClaimantBenefitsController';
import ClaimantClaimTypeDiscriminationController from '../../controllers/non-hmcts/ClaimantClaimTypeDiscriminationController';
import ClaimantClaimTypePayController from '../../controllers/non-hmcts/ClaimantClaimTypePayController';
import ClaimantCompensationController from '../../controllers/non-hmcts/ClaimantCompensationController';
import ClaimantDescribeWhatHappenedController from '../../controllers/non-hmcts/ClaimantDescribeWhatHappenedController';
import ClaimantDidWorkAtController from '../../controllers/non-hmcts/ClaimantDidWorkAtController';
import ClaimantEmploymentDetailsController from '../../controllers/non-hmcts/ClaimantEmploymentDetailsController';
import ClaimantEmploymentStartDateController from '../../controllers/non-hmcts/ClaimantEmploymentStartDateController';
import ClaimantEndDateController from '../../controllers/non-hmcts/ClaimantEndDateController';
import ClaimantLinkedCasesController from '../../controllers/non-hmcts/ClaimantLinkedCasesController';
import ClaimantNewJobController from '../../controllers/non-hmcts/ClaimantNewJobController';
import ClaimantNewJobPayController from '../../controllers/non-hmcts/ClaimantNewJobPayController';
import ClaimantNewJobStartDateController from '../../controllers/non-hmcts/ClaimantNewJobStartDateController';
import ClaimantNoAcasNumberController from '../../controllers/non-hmcts/ClaimantNoAcasNumberController';
import ClaimantNoticeEndController from '../../controllers/non-hmcts/ClaimantNoticeEndController';
import ClaimantNoticeLengthController from '../../controllers/non-hmcts/ClaimantNoticeLengthController';
import ClaimantNoticePeriodController from '../../controllers/non-hmcts/ClaimantNoticePeriodController';
import ClaimantNoticeTypeController from '../../controllers/non-hmcts/ClaimantNoticeTypeController';
import ClaimantPastNoticeTypeController from '../../controllers/non-hmcts/ClaimantPastNoticeTypeController';
import ClaimantPayController from '../../controllers/non-hmcts/ClaimantPayController';
import ClaimantPensionController from '../../controllers/non-hmcts/ClaimantPensionController';
import ClaimantPlaceOfWorkController from '../../controllers/non-hmcts/ClaimantPlaceOfWorkController';
import ClaimantRepCheckAnswersController from '../../controllers/non-hmcts/ClaimantRepCheckAnswersController';
import ClaimantRepClaimSubmittedController from '../../controllers/non-hmcts/ClaimantRepClaimSubmittedController';
import ClaimantRepHubController from '../../controllers/non-hmcts/ClaimantRepHubController';
import ClaimantRespondentAddRedirectController from '../../controllers/non-hmcts/ClaimantRespondentAddRedirectController';
import ClaimantRespondentAddressController from '../../controllers/non-hmcts/ClaimantRespondentAddressController';
import ClaimantRespondentAddressDetailsController from '../../controllers/non-hmcts/ClaimantRespondentAddressDetailsController';
import ClaimantRespondentDetailsCheckController from '../../controllers/non-hmcts/ClaimantRespondentDetailsCheckController';
import ClaimantRespondentNameController from '../../controllers/non-hmcts/ClaimantRespondentNameController';
import ClaimantRespondentPostcodeEnterController from '../../controllers/non-hmcts/ClaimantRespondentPostcodeEnterController';
import ClaimantRespondentPostcodeSelectController from '../../controllers/non-hmcts/ClaimantRespondentPostcodeSelectController';
import ClaimantRespondentSectionCheckController from '../../controllers/non-hmcts/ClaimantRespondentSectionCheckController';
import ClaimantTellUsWhatYouWantController from '../../controllers/non-hmcts/ClaimantTellUsWhatYouWantController';
import ClaimantTribunalRecommendationController from '../../controllers/non-hmcts/ClaimantTribunalRecommendationController';
import ClaimantTypeOfClaimController from '../../controllers/non-hmcts/ClaimantTypeOfClaimController';
import ClaimantWorkPostcodeEnterController from '../../controllers/non-hmcts/ClaimantWorkPostcodeEnterController';
import ClaimantWorkPostcodeSelectController from '../../controllers/non-hmcts/ClaimantWorkPostcodeSelectController';
import DidClaimantHaveWrittenContractController from '../../controllers/non-hmcts/DidClaimantHaveWrittenContractController';
import DidClaimantWorkForEmployerController from '../../controllers/non-hmcts/DidClaimantWorkForEmployerController';
import IsClaimantStillWorkingController from '../../controllers/non-hmcts/IsClaimantStillWorkingController';
import RepresentativeAddressDetailsController from '../../controllers/non-hmcts/RepresentativeAddressDetailsController';
import RepresentativeCommsPrefController from '../../controllers/non-hmcts/RepresentativeCommsPrefController';
import RepresentativeDetailsCheckController from '../../controllers/non-hmcts/RepresentativeDetailsCheckController';
import RepresentativeDetailsController from '../../controllers/non-hmcts/RepresentativeDetailsController';
import RepresentativePhoneNumberController from '../../controllers/non-hmcts/RepresentativePhoneNumberController';
import RepresentativePostCodeEnterController from '../../controllers/non-hmcts/RepresentativePostCodeEnterController';
import RepresentativePostCodeSelectController from '../../controllers/non-hmcts/RepresentativePostCodeSelectController';
import RepresentedClaimantAddressDetailsController from '../../controllers/non-hmcts/RepresentedClaimantAddressDetailsController';
import RepresentedClaimantDateOfBirthController from '../../controllers/non-hmcts/RepresentedClaimantDateOfBirthController';
import RepresentedClaimantDetailsCheckController from '../../controllers/non-hmcts/RepresentedClaimantDetailsCheckController';
import RepresentedClaimantEnterEmailController from '../../controllers/non-hmcts/RepresentedClaimantEnterEmailController';
import RepresentedClaimantEnterPostcodeController from '../../controllers/non-hmcts/RepresentedClaimantEnterPostcodeController';
import RepresentedClaimantNameController from '../../controllers/non-hmcts/RepresentedClaimantNameController';
import RepresentedClaimantSelectPostcodeController from '../../controllers/non-hmcts/RepresentedClaimantSelectPostcodeController';
import RepresentedClaimantSexAndTitleController from '../../controllers/non-hmcts/RepresentedClaimantSexAndTitleController';
import StepsToMakingYourClaimNonHmctsController from '../../controllers/non-hmcts/StepsToMakingYourClaimNonHmctsController';
import SubmitRepCaseController from '../../controllers/non-hmcts/SubmitRepCaseController';
...
export class Routes {
  public enableFor(app: Application): void {
    ...
    app.get(PageUrls.CLAIMANT_NOTICE_LENGTH, new ClaimantNoticeLengthController().get);
    ...
    app.get(PageUrls.CLAIMANT_RESPONDENT_NAME, new ClaimantRespondentNameController().get);
    app.post(PageUrls.CLAIMANT_RESPONDENT_NAME, new ClaimantRespondentNameController().post);
    app.get(PageUrls.CLAIMANT_RESPONDENT_ADDRESS, new ClaimantRespondentAddressController().get);
    app.get(PageUrls.CLAIMANT_RESPONDENT_POSTCODE_ENTER, new ClaimantRespondentPostcodeEnterController().get);
    app.post(PageUrls.CLAIMANT_RESPONDENT_POSTCODE_ENTER, new ClaimantRespondentPostcodeEnterController().post);
    app.get(PageUrls.CLAIMANT_RESPONDENT_POSTCODE_SELECT, new ClaimantRespondentPostcodeSelectController().get);
    app.post(PageUrls.CLAIMANT_RESPONDENT_POSTCODE_SELECT, new ClaimantRespondentPostcodeSelectController().post);
    app.get(PageUrls.CLAIMANT_RESPONDENT_ADDRESS_DETAILS, new ClaimantRespondentAddressDetailsController().get);
    app.post(PageUrls.CLAIMANT_RESPONDENT_ADDRESS_DETAILS, new ClaimantRespondentAddressDetailsController().post);
    app.get(PageUrls.CLAIMANT_DID_WORK_AT, new ClaimantDidWorkAtController().get);
    app.post(PageUrls.CLAIMANT_DID_WORK_AT, new ClaimantDidWorkAtController().post);
    app.get(PageUrls.CLAIMANT_ACAS_CERT_NUM, new ClaimantAcasCertNumController().get);
