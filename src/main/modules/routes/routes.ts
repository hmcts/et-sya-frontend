...
import RespondentAddressManualController from '../../controllers/RespondentAddressManualController';
...
export class Routes {
  public enableFor(app: Application): void {
    ...
    app.get(
      PageUrls.RESPONDENT_REST_PREFIX + PageUrls.RESPONDENT_ADDRESS_MANUAL,
      new RespondentAddressManualController().get
    );
    app.post(
      PageUrls.RESPONDENT_REST_PREFIX + PageUrls.RESPONDENT_ADDRESS_MANUAL,
      new RespondentAddressManualController().post
    );
