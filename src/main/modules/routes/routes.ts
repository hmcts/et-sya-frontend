...
import ClaimantAcasCertNumController from '../../controllers/ClaimantAcasCertNumController';
...
import GuidanceController from '../../controllers/multiples/GuidanceController';
import AddAnotherClaimantController from '../../controllers/multiples/et1-submission/AddAnotherClaimantController';
import AdditionalClaimantFileUploadController from '../../controllers/multiples/et1-submission/AdditionalClaimantFileUploadController';
import AdditionalClaimantPersonalDetailsController from '../../controllers/multiples/et1-submission/AdditionalClaimantPersonalDetailsController';
import AdditionalClaimantPostCodeEnterController from '../../controllers/multiples/et1-submission/AdditionalClaimantPostCodeEnterController';
import AdditionalClaimantPostCodeSelectController from '../../controllers/multiples/et1-submission/AdditionalClaimantPostCodeSelectController';
import GroupClaimsCheckController from '../../controllers/multiples/et1-submission/GroupClaimsCheckController';
import GroupRepresentativeController from '../../controllers/multiples/et1-submission/GroupRepresentativeController';
import RemoveAdditionalClaimantController from '../../controllers/multiples/et1-submission/RemoveAdditionalClaimantController';
import ReviewOtherClaimantsController from '../../controllers/multiples/et1-submission/ReviewAdditionalClaimantsController';
import SingleOrMultipleController from '../../controllers/multiples/et1-submission/SingleOrMultipleController';
...
const handleUploads = multer({
  limits: {
    fileSize: FILE_SIZE_LIMIT.EIGHTY_MB,
    fields: 20,
    fieldNestingDepth: 1,
...
export class Routes {
  public enableFor(app: Application): void {
    ...
    app.get(PageUrls.MULTIPLE_GUIDANCE, new GuidanceController().get);
