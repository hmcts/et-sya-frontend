...
export default class CSRFToken {
  public enableFor(app: Application): void {
    ...
    app.use((req: AppRequest, res, next) => {
      ...
      const skipCsrfPaths = ['/describe-what-happened', '/claimant-describe-what-happened'];
      ...
      const shouldSkip =
        skipCsrfPaths.includes(req.path) || skipCsrfPathPrefixes.some(prefix => req.path.startsWith(prefix));
