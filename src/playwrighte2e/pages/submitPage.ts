...
export class SubmitPage extends BasePage {
    ...
    async submitClaim(allEqualityPages: boolean) {
        ...
        if(allEqualityPages) {
            ...
            await this.webAction.verifyElementContainsText(this.page.locator('text=This information helps us check that we’re treating people equally and fairly. It helps us to meet our commitment to equality (under the Equality Act 2010).'), 'This information helps us check that we’re treating people equally and fairly. It helps us to meet our commitment to equality (under the Equality Act 2010).');
            ...
            await this.webAction.verifyTextIsVisible('text=Do you have any physical or mental health conditions or illnesses lasting or expected to last 12 months or more?');
            await this.webAction.clickElementByText('text=Why we are asking this question');
            await this.webAction.verifyElementContainsText(this.page.locator('text=This information helps us check that we’re treating people equally and fairly. It helps us to meet our commitment to equality (under the Equality Act 2010).'), 'This information helps us check that we’re treating people equally and fairly. It helps us to meet our commitment to equality (under the Equality Act 2010).');
            await this.webAction.checkElementById('//input[@value="0"]');
            await this.clickContinue();
